...
public class UIUtils {
    ...
    public static final String TARGET_FORM_FACTOR_ACTIVITY_METADATA =
            "com.google.android.apps.performgroup.meta.TARGET_FORM_FACTOR";
    ...
    public static void enableDisableActivitiesByFormFactor(Context context) {
        ...
        try {
            ...
            if (pi == null) {
                Log.d(TAG, "No package info found for our own package.");
                return;
            }
            ...
            Log.d(TAG, "No package info found for our own package.", e);
        } catch (ClassNotFoundException e) {
            Log.d(TAG, "Activity not found within package.", e);
        }
    }
