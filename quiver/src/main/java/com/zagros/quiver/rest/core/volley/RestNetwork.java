 ...
 */
public class RestNetwork implements Network {
     ...
     */
    public RestNetwork(HttpStack httpStack) {
     ...
     */
    public RestNetwork(HttpStack httpStack, ByteArrayPool pool) {
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                ...
                String ss = new String(responseContents);
